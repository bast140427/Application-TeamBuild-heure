...
public class ItemEvenement_prestataire extends ListCell<Prestation> {
    ...
    public ItemEvenement_prestataire() {
        super();
        FXMLLoader fxmlLoader = new FXMLLoader(controleur.getClass().getResource("modele_event_prestation.fxml"));
    ...
    protected void updateItem(Prestation e, boolean empty) {
        ...
        if (e != null) {
            controleur.setEvent_Prestation(e);
            setGraphic(rootNode);
        }else {
            setGraphic(null);
        }
